...
mod tests {
    ...
    const REAL_HEADER: [u8; 100] = [
        ...
        0x6d, 0x61, 0x74, 0x20, 0x33, 0x00, 0x10, 0x00, 0x01, 0x01,
        0x00, 0x40, 0x20, 0x20, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00,
    ...
    fn rejects_bad_magic() {
        ...
        bad[0] = b'X';
        assert!(matches!(DatabaseHeader::parse(&bad), Err(Error::Corrupt(_))));
    }
